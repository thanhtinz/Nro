                ...
                <table width="100%" cellspacing="4">
                    <tr class="menu">
                        ...
                        <td>
                            ...
                            <div class="bg_top_22">
                    <img src="https://103.162.30.23/images/banner_Summer.png" width="100%">
                </div>
...
var url;
 function openWinjar() {
        url = window
                .open("https://zalo.me/g/atqsvzxmfalbhc3n4d7d", "_blank", "width=786, height=786");
    }
	function openWinjad() {
        url = window
                .open("https://zalo.me/g/atqsvzxmfalbhc3n4d7d", "_blank", "width=786, height=786");
...
<div id="columns" style="text-align:center; display:flex; justify-content:center; gap:20px; flex-wrap:wrap;">						
	<figure>
    <a href="https://zalo.me/g/atqsvzxmfalbhc3n4d7d"
       target="_blank"
       title="CHÚ BÉ RỒNG ONLINE - JAVA">
        <img height="35"
             src="https://103.162.30.23/images/jar.png"
	...
	<!-- <figure>
		...
		<img height="35" src="https://103.162.30.23/images/android.png" alt="CHÚ BÉ RỒNG ONLINE">
		</a> 
		<figcaption><span style="color:rgb(209, 9, 50);">246</span>
		<br>
		<a href="https://103.162.30.23/?c=huong-dan">Hướng dẫn cài</a></figcaption> -->
	</figure> 
	<figure>
	  <a href="https://drive.google.com/file/d/1kgY9He33UQEJPgoVFWAXvXKKIpTjJJqq/view?usp=sharing" title="CHÚ BÉ RỒNG ONLINE">
		<img height="35" src="https://103.162.30.23/images/play.png" alt="CHÚ BÉ RỒNG ONLINE">
		</a>
	  <!-- <figcaption><span style="color:rgb(209, 9, 50);">246</span>  -->
		<br> <br></figcaption>
	</figure>
	...
	<figure>
	  <a href="https://drive.google.com/file/d/1MjpTa2A2ombyokhFNHnKnTRJv-wfBRTg/view?usp=sharing?usp=sharing?usp=sharing" title="CHÚ BÉ RỒNG ONLINE">
		<img height="35" src="https://103.162.30.23/images/pc.png" alt="CHÚ BÉ RỒNG ONLINE">
		</a>
	  <!-- <figcaption><span style="color:rgb(209, 9, 50);">246</span> -->
		<br> <br></figcaption>
	</figure>
	<figure>
		...
		<img style="margin-bottom:0px" height="35" src="https://103.162.30.23/images/ip.png" alt="CHÚ BÉ RỒNG ONLINE">
		</a>
	  <!-- <figcaption>
<br> -->
<!-- <a href="https://testflight.apple.com/join/FWEJoZEB">Testflight 1</a> <br> <br>
</figcaption> -->
	<!-- </figure>
	<figure>
	  <a href="https://pay.teamobi.com/?game=nr&name=" title="CHÚ BÉ RỒNG ONLINE"><img src="https://103.162.30.23/images/napngoc.png" height="35">
		</a>
		<figcaption><span style="color:rgb(209, 9, 50);"><a href="https://forum.103.162.30.23/app/index.php?for=event&do=sms&p=0&sz=15">Báo Lỗi SMS</a></span><br>
			<span style="color:rgb(209, 9, 50);"><a href="https://forum.103.162.30.23/app/index.php?for=event&do=report&p=0&sz=15">Báo Lỗi thẻ</a></span></figcaption>	
	</figure>
   -->
            ...
            <div class="bg-content">
                <div>
                    ...
                    <div class="content">
                        ...
                        <p class="text-center">
                            <img alt="" src="https://103.162.30.23/images/gif//gif_maphongba.gif">&nbsp;
                            <img alt="" src="https://103.162.30.23/images/gif//gif_gif_Saiyain.gif">&nbsp;
                            <img alt="" src="https://103.162.30.23/images/gif/gif_supber_kame.gif">&nbsp;
                        </p>

                        <p class="content-p">VIP</p>
                        <p class="text-center">
                            <img alt="" src="https://103.162.30.23/images/gif//gif_maphongba_VIP.gif">&nbsp;
                            <img alt="" src="https://103.162.30.23/images/gif//gif_gif_Saiyain_VIP.gif">&nbsp;
                            <img alt="" src="https://103.162.30.23/images/gif/gif_supber_kame_VIP.gif">&nbsp;
                        </p>
                        <p class="text-center">
                            <a href="https://103.162.30.23/?c=skill">Xem thêm</a>
                        </p>
                    </div>
                </div>
            </div>
...
<script src="https://103.162.30.23/view/static/js/ThreeCanvas.js" type="09944df4cd4f5d04eb164296-text/javascript"></script>
<script src="https://103.162.30.23/view/static/js/Snow3d.js" type="09944df4cd4f5d04eb164296-text/javascript"></script>
<script src="https://103.162.30.23/view/static/js/animation.js?v4" type="09944df4cd4f5d04eb164296-text/javascript"></script>
<script type="09944df4cd4f5d04eb164296-text/javascript">
    (function($) {
